...
vim.api.nvim_create_autocmd({ "BufWinEnter" }, {
	...
	group = vim.api.nvim_create_augroup("config-load-position", { clear = true }),
	pattern = "*",
...
require("lazy").setup({
...

	{
		...
		config = function()
			...
			vim.keymap.set("n", "<C-w>", "<cmd>BufferClose<CR>", { nowait = true })
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("gi", vim.lsp.buf.hover, "Show documentation")
					...
					map("gk", "v:lua vim.diagnostic.jump({count=-1, float=true})<CR>", "Previous diagnostics")
					map("gj", "v:lua vim.diagnostic.jump({count=1, float=true})<CR>", "Next diagnostics")
