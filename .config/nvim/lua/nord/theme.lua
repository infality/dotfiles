...
theme.loadTreeSitter = function ()
    ...
    local treesitter = {
        ...
        TSConstructor =             { fg = nord.brackets }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
	...
	--TSAnnotation =              { fg = nord.nord11_gui },    -- For C++/Dart attributes, annotations that can be attached to the code to denote some kind of meta information.
        ...
        TSPunctDelimiter =          { fg = nord.brackets }, -- For delimiters ie: `.`
        TSPunctBracket =            { fg = nord.brackets }, -- For brackets and parens.
        TSPunctSpecial =            { fg = nord.brackets }, -- For special punctutation that does not fall in the catagories before.
        --TSString =                  { fg = nord.nord14_gui },    -- For strings.
