...
local syntaxgroups = {
    ...
    LspDiagnosticsDefaultInformation = { fg = owncolors.yellow },
    LspDiagnosticsSignInformation = { fg = owncolors.yellow },
    LspDiagnosticsFloatingInformation = { fg = owncolors.yellow },
    LspDiagnosticsVirtualTextInformation = { fg = owncolors.yellow },
    LspDiagnosticsUnderlineInformation = { fg = owncolors.yellow },
